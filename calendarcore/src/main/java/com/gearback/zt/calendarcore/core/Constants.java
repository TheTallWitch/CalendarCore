package com.gearback.zt.calendarcore.core;
...
public class Constants {
    ...
    public static final String BROADCAST_UPDATE_EVENTS = "BROADCAST_UPDATE_EVENTS";
    public static final int BROADCAST_TO_MONTH_FRAGMENT_RESET_DAY = Integer.MAX_VALUE;
    public static final String FONT_PATH = "iranyekanregular.ttf";
